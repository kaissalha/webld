...
const ChatImagePreviewDialog = ({
	...
	return (
		<div className='pointer-events-none fixed inset-0 z-50 grid place-items-center p-4 md:p-10'>
			<button
					...
					<div className='flex min-h-0 flex-col gap-1'>
						...
						<p
							className={cn(
								...
								!statusLabel && canCountLines && lineCountLabel === null && "animate-pulse opacity-70"
							)}
						>
