...
const InputOTPSlot = ({
	...
	return (
		<div
			...
			className={cn(
				"data-[active=true]:aria-invalid:ring-destructive/20 dark:data-[active=true]:aria-invalid:ring-destructive/40 aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive shadow-xs border-input data-[active=true]:border-ring data-[active=true]:ring-ring/50 outline-hidden relative flex h-9 w-9 items-center justify-center border-y border-e text-sm transition-all first:rounded-s-md first:border-s last:rounded-e-md data-[active=true]:z-10 data-[active=true]:ring-[3px]",
				className
			)}
			{...props}
		>
