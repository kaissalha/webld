...
const DropdownMenuSubContent = ({
	...
	<DropdownMenuPrimitive.SubContent
		ref={ref}
		className={cn(
			"z-60 min-w-32 origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-2xl bg-popover p-1 shadow-lg ring-1 ring-border data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-end-2 data-[side=left]:rtl:slide-in-from-start-2 data-[side=right]:slide-in-from-start-2 data-[side=right]:rtl:slide-in-from-end-2 data-[side=top]:slide-in-from-bottom-2",
			className
		)}
		{...props}
	/>
...
const DropdownMenuContent = ({
	...
	<DropdownMenuPrimitive.Portal>
		<DropdownMenuPrimitive.Content
			...
			className={cn(
				"z-60 min-w-32 origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-2xl bg-popover p-1 shadow-md ring-1 ring-border data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-end-2 data-[side=left]:rtl:slide-in-from-start-2 data-[side=right]:slide-in-from-start-2 data-[side=right]:rtl:slide-in-from-end-2 data-[side=top]:slide-in-from-bottom-2",
				className
			)}
			{...props}
		/>
