...
const createPageHeaderStyles = (t: PdfxTheme) => {
	...
	return StyleSheet.create({
		...
		simpleLeft: { display: "flex", flexDirection: "column", flex: 1 },
		simpleRight: { display: "flex", flexDirection: "column", alignItems: "flex-end" },
		centeredContainer: {
			display: "flex",
		...
		logoContainer: { marginRight: spacing[4], width: 48, height: 48 },
		logoContent: { flex: 1, display: "flex", flexDirection: "column" },
		logoRightContainer: {
			display: "flex",
			flexDirection: "row",
			alignItems: "center",
		...
		logoRightContent: { flex: 1, display: "flex", flexDirection: "column" },
		logoRightLogoContainer: { marginLeft: spacing[4], width: 48, height: 48 },
		twoColumnContainer: {
			display: "flex",
			flexDirection: "row",
			alignItems: "flex-start",
		...
		twoColumnLeft: { display: "flex", flexDirection: "column", flex: 1 },
		twoColumnRight: { display: "flex", flexDirection: "column", alignItems: "flex-end" },
		contactInfo: {
			fontFamily: body.fontFamily,
			fontSize: t.primitives.typography.xs,
			color: c.mutedForeground,
...
export const PageHeader = ({
	...
	if (variant === "branded") {
		...
		if (background) containerStyles.push({ backgroundColor: resolveColor(background, theme.colors) });
