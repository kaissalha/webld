...
const createPageFooterStyles = (t: PdfxTheme) => {
	...
	return StyleSheet.create({
		...
		textCenter: { ...textBase, textAlign: "center", flex: 1 },
		textRight: { ...textBase, textAlign: "right" },
		textCenteredVariant: { ...textBase, textAlign: "center", marginBottom: spacing[1] },
		...
		threeColumnLeft: { display: "flex", flexDirection: "column", flex: 1 },
		threeColumnCenter: { display: "flex", flexDirection: "column", alignItems: "center", flex: 1 },
		threeColumnRight: { display: "flex", flexDirection: "column", alignItems: "flex-end", flex: 1 },
		companyName: { ...textBase, fontWeight: fontWeights.medium, color: c.foreground },
		contactInfoCenter: {
			...textBase,
			textAlign: "center",
		...
		detailedLeft: { display: "flex", flexDirection: "column", flex: 1 },
		detailedRight: { display: "flex", flexDirection: "column", alignItems: "flex-end" },
		companyBold: { ...textBase, fontWeight: fontWeights.bold, color: c.foreground },
		detailedPageNumber: {
			...textBase,
			textAlign: "center",
